    ...
    readonly body: {
        ...
        readonly properties: {
            readonly model: {
                ...
                readonly description: "The name of the model that will complete your prompt. Possible values include `sonar-small-chat`, `sonar-small-online`, `sonar-medium-chat`, `sonar-medium-online`, `mistral-7b-instruct`, and `mixtral-8x7b-instruct`.\n\nDefault: `mistral-7b-instruct`";
                readonly enum: readonly ["mistral-7b-instruct", "mixtral-8x7b-instruct", "sonar-small-chat", "sonar-medium-chat", "sonar-small-online", "sonar-medium-online", "codellama-70b-instruct"];
                readonly default: "mistral-7b-instruct";
            };
            readonly messages: {
